"""
This works, but is extremely slow. We need to optimize the embedding and retrieval process,
...
if uploaded_file is not None:
    ...
    # Define llm
    #llm = Ollama(model="deepseek-r1:1.5b") # change this to something else
    llm = Ollama(model="smollm2:360m") # change this to something else
    # Define the prompt
    prompt = """
